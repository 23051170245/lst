...
#使用pickle的1oad方法从磁盘文件反序列化加载一个之前保存的随机森林模型对象 with open ('rfc_model.pkl', 'rb') as f: 
...
#将类别代码映射到具体的类别名称 
    ...
    with col_logo: 
        ...
        if not submitted: 
            ...
            st.image ('https://www.2008php.com/2011_Website_appreciate/2011-03-13/20110313233731.jpg', width=300) 

        else: 

            st.image (f' https://www.2008php.com/2011_Website_appreciate/2011-03-13/20110313233731.jpg', width=300)
